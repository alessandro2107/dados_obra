...
item = book_ns.model('obra',{
    'proprietario': fields.String('Proprietario'),
    'empreiteiro': fields.String('empreiteiro'),
    'ende_obra': fields.String('ende_obra'),
    'valor': fields.Integer(0),
    'qnt_estacas': fields.Integer(0),
    'profundidade': fields.Integer(0),
    'data_inicio': fields.String('data_inicio'),
    'data_fim': fields.String('data_fim'),
})
